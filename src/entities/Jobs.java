 ...
 *  The information stored will be provide applicants with releveant information pertaining to the job.
 *
...
public class Jobs {
    private String contactEmail, jobType, jobID, jobDescrip;
     ...
     */
    public createJob(String contactEmail, String jobType, String jobID, String jobDescrip, Float salary, DateTime job)
    {
        /*
     ...
     * @return The unique ID assigned to this job
     */
    private void modJob(String contactEmail,String jobType,String jobDescrip,float salary,DateTime setDate){
        /*
